...
impl ThreadPoolTimer {
    pub fn Period(&self) -> windows_core::Result<super::super::Foundation::TimeSpan> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Period)(windows_core::Interface::as_raw(this), &mut result__).map(|| core::mem::transmute(result__))
        }
    }
    pub fn Delay(&self) -> windows_core::Result<super::super::Foundation::TimeSpan> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Delay)(windows_core::Interface::as_raw(this), &mut result__).map(|| core::mem::transmute(result__))
        }
    }
...
impl TimerDestroyedHandler {
    pub fn new<F: FnMut(windows_core::Ref<ThreadPoolTimer>) -> windows_core::Result<()> + Send + 'static>(invoke: F) -> Self {
...
#[repr(C)]
struct TimerDestroyedHandlerBox<F: FnMut(windows_core::Ref<ThreadPoolTimer>) -> windows_core::Result<()> + Send + 'static> {
    vtable: *const TimerDestroyedHandler_Vtbl,
    invoke: F,
    count: windows_core::imp::RefCount,
}
impl<F: FnMut(windows_core::Ref<ThreadPoolTimer>) -> windows_core::Result<()> + Send + 'static> TimerDestroyedHandlerBox<F> {
    ...
    unsafe extern "system" fn Invoke(this: *mut core::ffi::c_void, timer: *mut core::ffi::c_void) -> windows_core::HRESULT {
        unsafe {
            ...
            (this.invoke)(core::mem::transmute_copy(&timer)).into()
        }
    }
}
...
#[repr(C)]
struct TimerElapsedHandlerBox<F: FnMut(windows_core::Ref<ThreadPoolTimer>) -> windows_core::Result<()> + Send + 'static> {
    vtable: *const TimerElapsedHandler_Vtbl,
    invoke: F,
    count: windows_core::imp::RefCount,
}
impl<F: FnMut(windows_core::Ref<ThreadPoolTimer>) -> windows_core::Result<()> + Send + 'static> TimerElapsedHandlerBox<F> {
...
impl WorkItemHandler {
    pub fn new<F: FnMut(windows_core::Ref<super::super::Foundation::IAsyncAction>) -> windows_core::Result<()> + Send + 'static>(invoke: F) -> Self {
...
#[repr(C)]
struct WorkItemHandlerBox<F: FnMut(windows_core::Ref<super::super::Foundation::IAsyncAction>) -> windows_core::Result<()> + Send + 'static> {
    vtable: *const WorkItemHandler_Vtbl,
    invoke: F,
    count: windows_core::imp::RefCount,
}
impl<F: FnMut(windows_core::Ref<super::super::Foundation::IAsyncAction>) -> windows_core::Result<()> + Send + 'static> WorkItemHandlerBox<F> {

...
impl ISysStorageProviderEventSource {
    pub fn EventReceived<P0>(&self, handler: Option<P0>) -> windows_core::Result<i64>
    where
        P0: FnMut(windows_core::Ref<ISysStorageProviderEventSource>, windows_core::Ref<SysStorageProviderEventReceivedEventArgs>) -> windows_core::Result<()> + Send + 'static,
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).EventReceived)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(&handler.map(|closure| super::super::super::Foundation::TypedEventHandler::<ISysStorageProviderEventSource, SysStorageProviderEventReceivedEventArgs>::new(closure))), &mut result__).map(|| result__)
        }
    }
...
pub trait ISysStorageProviderHttpRequestProvider_Impl: windows_core::IUnknownImpl {
    fn SendRequestAsync(&self, request: windows_core::Ref<super::super::super::Web::Http::HttpRequestMessage>) -> windows_core::Result<super::super::super::Foundation::IAsyncOperation<super::super::super::Web::Http::HttpResponseMessage>>;
}
#[cfg(feature = "Web_Http")]

...
impl FocusSessionManager {
    ...
    pub fn IsFocusActiveChanged<P0>(&self, handler: Option<P0>) -> windows_core::Result<i64>
    where
        P0: FnMut(windows_core::Ref<FocusSessionManager>, windows_core::Ref<windows_core::IInspectable>) -> windows_core::Result<()> + Send + 'static,
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsFocusActiveChanged)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(&handler.map(|closure| super::super::Foundation::TypedEventHandler::<FocusSessionManager, windows_core::IInspectable>::new(closure))), &mut result__).map(|| result__)
        }
    }
...
pub trait IAdaptiveCard_Impl: windows_core::IUnknownImpl {
    fn ToJson(&self) -> windows_core::Result<windows_core::HSTRING>;
}
impl IAdaptiveCard_Vtbl {
    pub const fn new<Identity: IAdaptiveCard_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ToJson<Identity: IAdaptiveCard_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
...
pub trait IAdaptiveCardBuilderStatics_Impl: windows_core::IUnknownImpl {
...
impl IAdaptiveCardBuilderStatics_Vtbl {
    pub const fn new<Identity: IAdaptiveCardBuilderStatics_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateAdaptiveCardFromJson<Identity: IAdaptiveCardBuilderStatics_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, value: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
pub struct ISecurityAppManager_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub Register: unsafe extern "system" fn(*mut core::ffi::c_void, SecurityAppKind, *mut core::ffi::c_void, *mut core::ffi::c_void, bool, *mut windows_core::GUID) -> windows_core::HRESULT,
...
pub struct IShareWindowCommandSource_Vtbl {
    ...
    pub CommandRequested: unsafe extern "system" fn(*mut core::ffi::c_void, *mut core::ffi::c_void, *mut i64) -> windows_core::HRESULT,
    pub RemoveCommandRequested: unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub CommandInvoked: unsafe extern "system" fn(*mut core::ffi::c_void, *mut core::ffi::c_void, *mut i64) -> windows_core::HRESULT,
    pub RemoveCommandInvoked: unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
...
pub struct ITaskbarManager2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub IsSecondaryTilePinnedAsync: unsafe extern "system" fn(*mut core::ffi::c_void, *mut core::ffi::c_void, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
    ...
    pub TryUnpinSecondaryTileAsync: unsafe extern "system" fn(*mut core::ffi::c_void, *mut core::ffi::c_void, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
}
...
pub struct IWindowTab_Vtbl {
    ...
    pub TreatAsSecondaryTileId: unsafe extern "system" fn(*mut core::ffi::c_void, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
    pub SetTreatAsSecondaryTileId: unsafe extern "system" fn(*mut core::ffi::c_void, *mut core::ffi::c_void) -> windows_core::HRESULT,
...
pub struct IWindowTabIconStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateFromFontGlyph: unsafe extern "system" fn(*mut core::ffi::c_void, *mut core::ffi::c_void, *mut core::ffi::c_void, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
    pub CreateFromFontGlyphWithUri: unsafe extern "system" fn(*mut core::ffi::c_void, *mut core::ffi::c_void, *mut core::ffi::c_void, *mut core::ffi::c_void, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
...
pub struct IWindowTabManager_Vtbl {
    ...
    pub TabCloseRequested: unsafe extern "system" fn(*mut core::ffi::c_void, *mut core::ffi::c_void, *mut i64) -> windows_core::HRESULT,
    pub RemoveTabCloseRequested: unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub TabTearOutRequested: unsafe extern "system" fn(*mut core::ffi::c_void, *mut core::ffi::c_void, *mut i64) -> windows_core::HRESULT,
    pub RemoveTabTearOutRequested: unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub TabThumbnailRequested: unsafe extern "system" fn(*mut core::ffi::c_void, *mut core::ffi::c_void, *mut i64) -> windows_core::HRESULT,
    pub RemoveTabThumbnailRequested: unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
...
impl SecurityAppManager {
    ...
    pub fn Register<P2>(&self, kind: SecurityAppKind, displayname: &windows_core::HSTRING, detailsuri: P2, registerperuser: bool) -> windows_core::Result<windows_core::GUID>
    where
...
impl ShareWindowCommandSource {
    ...
    pub fn CommandRequested<P0>(&self, handler: Option<P0>) -> windows_core::Result<i64>
    where
        P0: FnMut(windows_core::Ref<ShareWindowCommandSource>, windows_core::Ref<ShareWindowCommandEventArgs>) -> windows_core::Result<()> + Send + 'static,
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CommandRequested)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(&handler.map(|closure| super::super::Foundation::TypedEventHandler::<ShareWindowCommandSource, ShareWindowCommandEventArgs>::new(closure))), &mut result__).map(|| result__)
        }
    }
    ...
    pub fn CommandInvoked<P0>(&self, handler: Option<P0>) -> windows_core::Result<i64>
    where
        P0: FnMut(windows_core::Ref<ShareWindowCommandSource>, windows_core::Ref<ShareWindowCommandEventArgs>) -> windows_core::Result<()> + Send + 'static,
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CommandInvoked)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(&handler.map(|closure| super::super::Foundation::TypedEventHandler::<ShareWindowCommandSource, ShareWindowCommandEventArgs>::new(closure))), &mut result__).map(|| result__)
        }
    }
...
impl WindowTabManager {
    ...
    pub fn TabSwitchRequested<P0>(&self, handler: Option<P0>) -> windows_core::Result<i64>
    where
        P0: FnMut(windows_core::Ref<WindowTabManager>, windows_core::Ref<WindowTabSwitchRequestedEventArgs>) -> windows_core::Result<()> + Send + 'static,
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TabSwitchRequested)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(&handler.map(|closure| super::super::Foundation::TypedEventHandler::<WindowTabManager, WindowTabSwitchRequestedEventArgs>::new(closure))), &mut result__).map(|| result__)
        }
    }
    ...
    pub fn TabCloseRequested<P0>(&self, handler: Option<P0>) -> windows_core::Result<i64>
    where
        P0: FnMut(windows_core::Ref<WindowTabManager>, windows_core::Ref<WindowTabCloseRequestedEventArgs>) -> windows_core::Result<()> + Send + 'static,
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TabCloseRequested)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(&handler.map(|closure| super::super::Foundation::TypedEventHandler::<WindowTabManager, WindowTabCloseRequestedEventArgs>::new(closure))), &mut result__).map(|| result__)
        }
    }
    ...
    pub fn TabTearOutRequested<P0>(&self, handler: Option<P0>) -> windows_core::Result<i64>
    where
        P0: FnMut(windows_core::Ref<WindowTabManager>, windows_core::Ref<WindowTabTearOutRequestedEventArgs>) -> windows_core::Result<()> + Send + 'static,
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TabTearOutRequested)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(&handler.map(|closure| super::super::Foundation::TypedEventHandler::<WindowTabManager, WindowTabTearOutRequestedEventArgs>::new(closure))), &mut result__).map(|| result__)
        }
    }
    ...
    pub fn TabThumbnailRequested<P0>(&self, handler: Option<P0>) -> windows_core::Result<i64>
    where
        P0: FnMut(windows_core::Ref<WindowTabManager>, windows_core::Ref<WindowTabThumbnailRequestedEventArgs>) -> windows_core::Result<()> + Send + 'static,
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TabThumbnailRequested)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(&handler.map(|closure| super::super::Foundation::TypedEventHandler::<WindowTabManager, WindowTabThumbnailRequestedEventArgs>::new(closure))), &mut result__).map(|| result__)
        }
    }

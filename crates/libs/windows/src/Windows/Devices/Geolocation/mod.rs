...
impl Geolocator {
    ...
    where
        P0: FnMut(windows_core::Ref<Geolocator>, windows_core::Ref<PositionChangedEventArgs>) -> windows_core::Result<()> + Send + 'static,
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PositionChanged)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(&handler.map(|closure| super::super::Foundation::TypedEventHandler::<Geolocator, PositionChangedEventArgs>::new(closure))), &mut result__).map(|| result__)
        }
    }
    ...
    where
        P0: FnMut(windows_core::Ref<Geolocator>, windows_core::Ref<StatusChangedEventArgs>) -> windows_core::Result<()> + Send + 'static,
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).StatusChanged)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(&handler.map(|closure| super::super::Foundation::TypedEventHandler::<Geolocator, StatusChangedEventArgs>::new(closure))), &mut result__).map(|| result__)
        }
    }
...
impl GeovisitMonitor {
    ...
    pub fn VisitStateChanged<P0>(&self, handler: Option<P0>) -> windows_core::Result<i64>
    where
        P0: FnMut(windows_core::Ref<GeovisitMonitor>, windows_core::Ref<GeovisitStateChangedEventArgs>) -> windows_core::Result<()> + Send + 'static,
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).VisitStateChanged)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(&handler.map(|closure| super::super::Foundation::TypedEventHandler::<GeovisitMonitor, GeovisitStateChangedEventArgs>::new(closure))), &mut result__).map(|| result__)
        }
    }
...
pub struct IGeovisitMonitor_Vtbl {
    ...
    pub VisitStateChanged: unsafe extern "system" fn(*mut core::ffi::c_void, *mut core::ffi::c_void, *mut i64) -> windows_core::HRESULT,
    pub RemoveVisitStateChanged: unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}

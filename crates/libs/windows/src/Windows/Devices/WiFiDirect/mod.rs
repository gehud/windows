...
pub struct IWiFiDirectDeviceStatics2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub GetDeviceSelector: unsafe extern "system" fn(*mut core::ffi::c_void, WiFiDirectDeviceSelectorType, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
    #[cfg(feature = "Devices_Enumeration")]
...
impl WiFiDirectAdvertisementPublisher {
    ...
    where
        P0: FnMut(windows_core::Ref<WiFiDirectAdvertisementPublisher>, windows_core::Ref<WiFiDirectAdvertisementPublisherStatusChangedEventArgs>) -> windows_core::Result<()> + Send + 'static,
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).StatusChanged)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(&handler.map(|closure| super::super::Foundation::TypedEventHandler::<WiFiDirectAdvertisementPublisher, WiFiDirectAdvertisementPublisherStatusChangedEventArgs>::new(closure))), &mut result__).map(|| result__)
        }
    }
...
impl WiFiDirectConnectionListener {
    ...
    pub fn ConnectionRequested<P0>(&self, handler: Option<P0>) -> windows_core::Result<i64>
    where
        P0: FnMut(windows_core::Ref<WiFiDirectConnectionListener>, windows_core::Ref<WiFiDirectConnectionRequestedEventArgs>) -> windows_core::Result<()> + Send + 'static,
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ConnectionRequested)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(&handler.map(|closure| super::super::Foundation::TypedEventHandler::<WiFiDirectConnectionListener, WiFiDirectConnectionRequestedEventArgs>::new(closure))), &mut result__).map(|| result__)
        }
    }
...
impl WiFiDirectDevice {
    ...
    where
        P0: FnMut(windows_core::Ref<WiFiDirectDevice>, windows_core::Ref<windows_core::IInspectable>) -> windows_core::Result<()> + Send + 'static,
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ConnectionStatusChanged)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(&handler.map(|closure| super::super::Foundation::TypedEventHandler::<WiFiDirectDevice, windows_core::IInspectable>::new(closure))), &mut result__).map(|| result__)
        }
    }

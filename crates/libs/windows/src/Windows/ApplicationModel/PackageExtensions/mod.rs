...
pub struct IPackageExtension_Vtbl {
    ...
    pub GetPublicPath: unsafe extern "system" fn(*mut core::ffi::c_void, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
...
pub struct IPackageExtensionCatalogStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub Open: unsafe extern "system" fn(*mut core::ffi::c_void, *mut core::ffi::c_void, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
}
...
impl PackageExtension {
    ...
    pub fn GetPublicPath(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetPublicPath)(windows_core::Interface::as_raw(this), &mut result__).map(|| core::mem::transmute(result__))
        }
    }
    #[cfg(feature = "Storage_Search")]
...
impl PackageExtensionCatalog {
    ...
    where
        P0: FnMut(windows_core::Ref<PackageExtensionCatalog>, windows_core::Ref<PackageExtensionPackageInstalledEventArgs>) -> windows_core::Result<()> + Send + 'static,
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PackageInstalled)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(&handler.map(|closure| super::super::Foundation::TypedEventHandler::<PackageExtensionCatalog, PackageExtensionPackageInstalledEventArgs>::new(closure))), &mut result__).map(|| result__)
        }
    }
    ...
    where
        P0: FnMut(windows_core::Ref<PackageExtensionCatalog>, windows_core::Ref<PackageExtensionPackageUpdatingEventArgs>) -> windows_core::Result<()> + Send + 'static,
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PackageUpdating)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(&handler.map(|closure| super::super::Foundation::TypedEventHandler::<PackageExtensionCatalog, PackageExtensionPackageUpdatingEventArgs>::new(closure))), &mut result__).map(|| result__)
        }
    }
    ...
    where
        P0: FnMut(windows_core::Ref<PackageExtensionCatalog>, windows_core::Ref<PackageExtensionPackageUpdatedEventArgs>) -> windows_core::Result<()> + Send + 'static,
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PackageUpdated)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(&handler.map(|closure| super::super::Foundation::TypedEventHandler::<PackageExtensionCatalog, PackageExtensionPackageUpdatedEventArgs>::new(closure))), &mut result__).map(|| result__)
        }
    }
    ...
    where
        P0: FnMut(windows_core::Ref<PackageExtensionCatalog>, windows_core::Ref<PackageExtensionPackageUninstallingEventArgs>) -> windows_core::Result<()> + Send + 'static,
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PackageUninstalling)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(&handler.map(|closure| super::super::Foundation::TypedEventHandler::<PackageExtensionCatalog, PackageExtensionPackageUninstallingEventArgs>::new(closure))), &mut result__).map(|| result__)
        }
    }
    ...
    where
        P0: FnMut(windows_core::Ref<PackageExtensionCatalog>, windows_core::Ref<PackageExtensionPackageStatusChangedEventArgs>) -> windows_core::Result<()> + Send + 'static,
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PackageStatusChanged)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(&handler.map(|closure| super::super::Foundation::TypedEventHandler::<PackageExtensionCatalog, PackageExtensionPackageStatusChangedEventArgs>::new(closure))), &mut result__).map(|| result__)
        }
    }
    ...
    fn IPackageExtensionCatalogStatics<R, F: FnOnce(&IPackageExtensionCatalogStatics) -> windows_core::Result<R>>(callback: F) -> windows_core::Result<R> {
...
impl PackageExtensionPackageInstalledEventArgs {
    pub fn PackageExtensionName(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PackageExtensionName)(windows_core::Interface::as_raw(this), &mut result__).map(|| core::mem::transmute(result__))
        }
    }
    pub fn Package(&self) -> windows_core::Result<super::Package> {
        let this = self;

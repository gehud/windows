...
impl SizeChangedEventHandler {
    pub fn new<F: FnMut(windows_core::Ref<WebUICommandBarSizeChangedEventArgs>) -> windows_core::Result<()> + Send + 'static>(invoke: F) -> Self {
...
#[repr(C)]
struct SizeChangedEventHandlerBox<F: FnMut(windows_core::Ref<WebUICommandBarSizeChangedEventArgs>) -> windows_core::Result<()> + Send + 'static> {
    vtable: *const SizeChangedEventHandler_Vtbl,
    invoke: F,
    count: windows_core::imp::RefCount,
}
impl<F: FnMut(windows_core::Ref<WebUICommandBarSizeChangedEventArgs>) -> windows_core::Result<()> + Send + 'static> SizeChangedEventHandlerBox<F> {

...
impl FileInformation {
    ...
    pub fn ThumbnailUpdated<P0>(&self, changedhandler: Option<P0>) -> windows_core::Result<i64>
    where
        P0: FnMut(windows_core::Ref<IStorageItemInformation>, windows_core::Ref<windows_core::IInspectable>) -> windows_core::Result<()> + Send + 'static,
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ThumbnailUpdated)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(&changedhandler.map(|closure| super::super::Foundation::TypedEventHandler::<IStorageItemInformation, windows_core::IInspectable>::new(closure))), &mut result__).map(|| result__)
        }
    }
    ...
    pub fn PropertiesUpdated<P0>(&self, changedhandler: Option<P0>) -> windows_core::Result<i64>
    where
        P0: FnMut(windows_core::Ref<IStorageItemInformation>, windows_core::Ref<windows_core::IInspectable>) -> windows_core::Result<()> + Send + 'static,
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PropertiesUpdated)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(&changedhandler.map(|closure| super::super::Foundation::TypedEventHandler::<IStorageItemInformation, windows_core::IInspectable>::new(closure))), &mut result__).map(|| result__)
        }
    }
